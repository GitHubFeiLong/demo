...
<body>
   ...
   <script>
     $.ajax({
      ...
      $("#table").datagrid({
         url: '/ssm/page/getPage.do',//完整格式为{total:35,rows:[{a:1,b:2,c:3},{a:1,b:2,c:3},{a:1,b:2,c:3}],footer:[{'a':'统计',b:'',c:''}]},,,total为总共多少条数据，rows为表格要显示的数组对象，footer为行尾，默认不显示，如统计合计
         width:"100%",
         height: 200,//高度
       ...
       $("#table2").datagrid({
         url: '/ssm/page/getStudent.do',//完整格式为{total:35,rows:[{a:1,b:2,c:3},{a:1,b:2,c:3},{a:1,b:2,c:3}],footer:[{'a':'统计',b:'',c:''}]},,,total为总共多少条数据，rows为表格要显示的数组对象，footer为行尾，默认不显示，如统计合计
         width:"100%",
         height: 200,//高度
         pagination: true,//显示分页组件,
         pageSize: 50,//一页显示多少条，排序，post返回给后台 page:'1',rows:'10'
